...
{
    public partial class Out_Letter_De : Form
    {
        public Out_Letter_De()
        {
            InitializeComponent();
        }

        bool is_del_clicked = false;
        private void Out_Letter_De_Load(object sender, EventArgs e)
        {
            //-----------------------
        ...
        void object_perm_loader()
        {
            ...
            this.add_butt.Enabled = MyClass.get_permission_by_col_name("Out_de_b1");// new
            this.edit_butt.Enabled = MyClass.get_permission_by_col_name("Out_de_b2");//edit
            this.del_butt.Enabled = MyClass.get_permission_by_col_name("Out_de_b3");//del
            this.print_butt.Enabled = MyClass.get_permission_by_col_name("Out_de_b4");//print                               //-------------------------------------------------------------
            //-----------
        ...
        private void add_butt_Click(object sender, EventArgs e)
        {
            ...
            //-----------------------
            this.out_letters_bindingSource1.AddNew();
            sys_date_time();
            //-------
            this.sent_time_maskedTextBox1.Text = System.DateTime.Now.ToShortTimeString();
            ...
            this.sent_time_maskedTextBox1.Text = new System.DateTime(2000, 1, 1, 23, 40, 50).ToShortTimeString();
            //-----------------------
            is_del_clicked = false;
        }
        ...
        private void del_butt_Click(object sender, EventArgs e)
        {
            disable_del_butt();
            //---------------------------
            this.out_letters_bindingSource1.RemoveCurrent();
            //---------------------------
            is_del_clicked = true;
        }
        ...
        private void save_butt_Click(object sender, EventArgs e)
        {
            try
            {
                if (is_del_clicked == false)
                {
                    ...
                    //====================
                    if (this.sent_date_maskedTextBox2.Text != "__/__/____")
                    {
                        b = DateTime.TryParse(this.sent_date_maskedTextBox2.Text, out rr);
                        //-----
                        if (b == false)
                        {
                ...
                //---------------------------
                //---------------------------
                this.out_letters_bindingSource1.EndEdit();
                //---------------------------
                int r;
                //-------------
                //to do
                 this.sa_Out_LettersTableAdapter1.Connection.ConnectionString = Secretariat_Soft.MyClasses.ComClass.MyConn_String;
                //-------------
                r = this.sa_Out_LettersTableAdapter1.Update(this.letters1.Sa_Out_Letters);
                //---------------------------
                if (r > 0)
                {
        ...
        private void cancel_butt_Click(object sender, EventArgs e)
        {
            enable_add_edit_del_butt();
            //------------------------
            this.out_letters_bindingSource1.CancelEdit();
            this.letters1.Sa_Out_Letters.RejectChanges();
            //------------------------
        }
        ...
        {
            this.sent_date_maskedTextBox2.Text = System.DateTime.Now.ToShortDateString();
        }
        ...
        private void Out_Letter_De_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.F2:
